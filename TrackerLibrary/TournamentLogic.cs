...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        {
            List<TeamModel> randomizedTeams = RandomiseTeamOrder(model.EnteredTeams);
        ...
        {
            // ideally verified with Regex.. but it is process expensive
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            //recall Where statement gives an IEnumerable list.
